...
- `DataDb` owns only authored, file-backed content loaded from `Data/*.json`.
...
- Authored data is read from disk and treated as immutable at runtime.
- Runtime-generated items, recipes, and other discovered content must be stored separately from authored JSON content.
